        ...
        highlight_overrides = {
          mocha = function(colors)
            return {
              ...
              BlinkCmpLabelMatch = { bg = colors.none, fg = colors.red },
              ...
              TSFunction = { fg = colors.sapphire, style = { "bold", "italic" } },
              ...
              TsxTagAttribute = { fg = colors.pink },
